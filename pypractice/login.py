...
username = driver.find_element(By.XPATH,"//ul[@class='nav navbar-nav']/descendant::a[10]").text
assert username=="Logged in as demo"
print("logged in using username in successful")
